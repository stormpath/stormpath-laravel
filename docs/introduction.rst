...
Not sure if Stormpath-Laravel is for you?  Read along, and I'll help you decide
whether or not Stormpath-Laravel is a good fit for your project!
...
Laravel package will cover most features that you need for your web application,
...
- You want to make user creation, management, and security as simple as possible
  (you can get started with Stormpath-Laravel with only a few lines of code
  *excluding settings*)!
